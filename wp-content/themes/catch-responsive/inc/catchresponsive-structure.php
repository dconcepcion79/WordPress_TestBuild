...
if ( ! function_exists( 'catchresponsive_layout_condition_check' ) ) :
	/**
	 * Layout Optons Condition Check and Hook
	 *
	 * @since Catch Responsive 1.0
	 */
	function catchresponsive_layout_condition_check() {
	...
	} // catchresponsive_layout_condition_check
endif;
add_action( 'catchresponsive_before', 'catchresponsive_layout_condition_check' ); 
