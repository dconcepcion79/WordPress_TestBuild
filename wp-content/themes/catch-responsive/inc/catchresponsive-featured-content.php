			...
			$catchresponsive_page_content .= '
				...
				$catchresponsive_page_content .= '
					<div class="entry-container">';
						...
						$catchresponsive_page_content .= '<p>'. get_the_content( $more_link_text , true ) .'</p>';
						$catchresponsive_page_content .= '<a href="' . get_permalink() . '" title="Permalink to '.the_title( '', '', false ).'"></a>';
					$catchresponsive_page_content .= '
					</div><!-- .entry-container -->
