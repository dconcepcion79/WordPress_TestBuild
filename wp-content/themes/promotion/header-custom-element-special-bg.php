...
<?php if ( get_post_meta($post->ID, 'custom_header_id', true) ) : ?>
	...
	<?php if (get_option_tree('slider_shadows', '')) {} else { 
echo '<div class="subhead_shadow"></div>'; } ?>
	<div id="custom_header" class="size-wrap">
	<img class="custom_header_img" src="<?php echo wp_get_attachment_url(get_post_meta($post->ID, 'custom_header_id', true)); ?> " alt="<?php bloginfo('name'); ?>" />
	</div><!--#custom_header-->
	<?php if (get_option_tree('slider_shadows', '')) {} else { 
...
if (!get_option_tree('slider_shadows', '')) { echo '<div class="subhead_shadow"></div>'; } 
echo '<div id="subhead_slider"><div id="custom_header" class="size-wrap">', do_shortcode( get_option_tree('blog_header_html')); 
if (!get_option_tree('slider_shadows', '')) {echo '<div class="subhead_shadow_bottom"></div>'; } echo '</div></div>'; } ?>
