...
if ( !defined('WP_CONTENT_URL') ) {
	define('SMW_PLUGINPATH',  get_template_directory_uri() . '/functions/widgets/social-widget/');
	define('SMW_PLUGINDIR', TEMPLATEPATH . '/functions/widgets/social-widget/');
} else {
	define('SMW_PLUGINPATH',  get_template_directory_uri() . '/functions/widgets/social-widget/');
	define('SMW_PLUGINDIR', TEMPLATEPATH . '/functions/widgets/social-widget/');
...
class Social_Widget extends WP_Widget {
	...
	function Social_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'social-widget', __('CUSTOM - Social Media Widget', 'smw'), $widget_ops, $control_ops );
	}
	...
	<p><em>If you selected "Custom Icon Pack" from the beginning of this form, input the URL and path to those icons in the following boxes.<br/><br/>
...
<br/>2.Upload your icons into that folder. It'll probably be a good idea if they are all the same size.
<br/>3. Go to the Widget Control Panel (Admin -> Appearance -> Widgets)
<br/>4. Select "Custom Icons" as the Icon Pack
<br/>5. Enter the URL to the icon pack folder (http://www.yoursite.com/blog/wp-content/icons)
<br/>6. Enter the FULL PATH to the icon pack folder (/var/www/html/yoursite/blog/wp-content/icons)
<br/>7. Click Save
</em></p><br />
	</p>
