        ...
        <table class="form-table">
          <tbody>
            ...
            <tr>
              ...
              <td><input type="text" name="onStart" value="<?php echo $moover['onStart'] ?>" style="width:300px"></td>
            </tr>
            <tr>
              ...
              <td><input type="text" name="onSlideSwitch" value="<?php echo $moover['onSlideSwitch'] ?>" style="width:300px"></td>
            </tr>
            <tr>
              <th scope="row"><label><strong>onSlideSwitchEnd</strong> Callback Function :</label>
                ...
                <strong>For example : myOnSlideSwitchFunction</strong></span> </th>
              <td><input type="text" name="onSlideSwitchEnd" value="<?php echo $moover['onSlideSwitchEnd'] ?>" style="width:300px"></td>
            </tr>
          </tbody>
        </table>
      </div>
