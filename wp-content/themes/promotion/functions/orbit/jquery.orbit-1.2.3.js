...
// ==============
            ...
            if(options.timer) {         	
                ...
                var timer = $j('div.timer'),
                	timerRunning;
                if(timer.length != 0) {
                    var rotator = $j('div.timer span.rotator'),
                    	mask = $j('div.timer span.mask'),
                    	pause = $j('div.timer span.pause'),
                    	degrees = 0,
                    	clock; 
                    startClock();
                ...
                if(!locked) {
                    ...
                    if(options.animation == "horizontal-push") {
                        if(slideDirection == "next") {
                            ...
                            slides
                            	.eq(prevActiveSlide)
                            	.animate({"left" : -960}, options.animationSpeed);
                        }
                        if(slideDirection == "prev") {
                            slides
                            	.eq(activeSlide)
