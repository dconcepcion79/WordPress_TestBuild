...
class OT_Admin
{
  ...
  function __construct() 
  {
    ...
    $this->ot_file   = '/functions/theme_options/theme_option_data/theme-options.xml';
    $this->ot_data   = '/functions/theme_options/theme_option_data/theme-options.txt';
    $this->ot_layout = '';
  ...
  function option_tree_default_data() 
  {
    ...
    else
    {
      ...
      // only run these queries if no xml file exist
        ...
        VALUES ( %s, %s, %s ) ", 
        array('general_default','Dotted','heading') ) );
  ...
  function option_tree_admin() 
  {
    ...
    if ( $this->has_xml == true && $this->show_docs == false )
    {
      ...
      // create menu items
      add_object_page( 'ThemeOptions', 'Theme Options', 'manage_options', 'option_tree', array( $this, 'option_tree_options_page' ), $icon);
      $option_tree_options = add_submenu_page( 'option_tree', 'ThemeOptions', 'Theme Settings', 'manage_options', 'option_tree', array( $this, 'option_tree_options_page' ) );
    ...
    else
    {
      ...
      add_object_page( 'ThemeOptions', 'Theme Options', 'manage_options', 'option_tree', array( $this, 'option_tree_options_page' ), $icon);
      $option_tree_options = add_submenu_page( 'option_tree', 'ThemeOptions', 'Theme Settings', 'manage_options', 'option_tree', array( $this, 'option_tree_options_page' ) );
      $option_tree_docs = add_submenu_page( 'option_tree', 'ThemeOptions', 'Documentation', 'manage_options', 'option_tree_docs', array( $this, 'option_tree_docs_page' ) );
      $option_tree_settings = add_submenu_page( 'option_tree', 'ThemeOptions', 'Settings', 'manage_options', 'option_tree_settings', array( $this, 'option_tree_settings_page' ) );
