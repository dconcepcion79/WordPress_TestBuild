<?php
	...
	// Wrapping shortcode
		...
		$return .= '<p><label>' . __( 'Content', 'care' ) . '</label><input type="text" name="su-generator-content" id="su-generator-content" value="' . $shortcode['content'] . '" /></p>';
	}

	$return .= '<p><a href="#" class="button-primary" id="su-generator-insert">' . __( 'Insert', 'care' ) . '</a> ';
	//$return .= '<a href="' . su_plugin_url() . '/images/demo/' . $_GET['shortcode'] . '.png" target="_blank" class="button alignright">' . __( 'Demo', 'care' ) . '</a></p>';
