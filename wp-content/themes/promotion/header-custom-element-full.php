...
<?php if ( get_post_meta($post->ID, 'custom_header_id', true) ) : ?>
	<div id="subhead_full">
	<?php if (get_option_tree('cfw_inner_shadows', '')) {} else { 
...
if (!get_option_tree('cfw_inner_shadows', '')){ echo '<div class="subhead_shadow"></div>'; } 
echo '<div id="subhead_full">', do_shortcode( get_option_tree('blog_header_html'));
if (!get_option_tree('cfw_inner_shadows', '')) { echo '<div class="subhead_shadow_bottom"></div>'; } echo '</div>';} ?>
