...
if (!get_option_tree('disable_subhead_inner_shadows', '')){echo '<div class="subhead_shadow"></div>'; }
echo '<div id="subhead"><div id="custom_header">', do_shortcode( get_option_tree('blog_header_html'));
if (!get_option_tree('disable_subhead_inner_shadows', '')) {echo '<div class="subhead_shadow_bottom"></div>'; } echo '</div></div>'; } ?>
