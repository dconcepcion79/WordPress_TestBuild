...
{name: "header-background-color", selector: ".gdlr-header-wrapper{ background: #gdlr#; }"},
{name: "header-right-text", selector: ".logo-right-area{ color: #gdlr#; }"},
{name: "header-right-divider", selector: ".logo-right-area .header-block-area{ border-color: #gdlr#; }"},
{name: "search-button-divider", selector: "#gdlr-menu-search-button{ border-color: #gdlr#; }"},
{name: "search-button-icon-color", selector: "#gdlr-menu-search-button{ color: #gdlr#; }"},
{name: "search-box-background", selector: "#gdlr-menu-search{ background: #gdlr#; }"},
{name: "search-box-text", selector: "#gdlr-menu-search input[type=\"text\"]{ color: #gdlr#; }"},
{name: "main-navigation-background", selector: ".gdlr-navigation-wrapper{ background-color: #gdlr#; }"},
{name: "main-navigation-text", selector: ".gdlr-navigation-wrapper .gdlr-main-menu > li > a{ color: #gdlr#; }"},
...
{name: "main-navigation-divider", selector: ".gdlr-navigation-wrapper .gdlr-main-menu > li > a{ border-color: #gdlr#; }"},
...
{name: "body-link-color", selector: "a{ color: #gdlr#; }a i.fa-angle-double-right, a i.icon-double-angle-right{ border-color: #gdlr#; }a.gdlr-item-title-link, a.gdlr-item-title-link:hover{ color: #gdlr#; border-color: #gdlr#; }"},
{name: "body-link-hover-color", selector: "a:hover{ color: #gdlr#; }a:hover i.fa-angle-double-right, a:hover i.icon-double-angle-right{ border-color: #gdlr#; }"},
...
{name: "stunning-text-link-color", selector: ".stunning-text-button, .stunning-text-button:hover{ color: #gdlr#; }.stunning-text-button{ border-color: #gdlr#; border-color: rgba(#gdlra#, 0.5); }"},
{name: "stunning-text-background", selector: ".gdlr-stunning-text-item{ background-color: #gdlr#; }"},
...
{name: "tab-title-active-background", selector: ".tab-title-wrapper .tab-title.active{ background-color: #gdlr#; }.gdlr-tab-item > .tab-title-wrapper{ border-color: #gdlr#; }"},
{name: "tab-title-active-text", selector: ".tab-title-wrapper .tab-title.active{ color: #gdlr#; }"},
...
{name: "blog-info-color", selector: ".blog-info, .blog-info a{ color: #gdlr#; }"},
{name: "blog-info-icon", selector: ".blog-info i{ color: #gdlr#; }"},
{name: "blog-widget-background", selector: ".gdlr-blog-widget{ background-color: #gdlr#; }"},
{name: "blog-widget-title", selector: ".gdlr-blog-widget .gdlr-blog-title a{ color: #gdlr#; }"},
{name: "blog-widget-info", selector: ".gdlr-blog-widget .blog-info, .gdlr-blog-widget .blog-info i, .gdlr-blog-widget .blog-info a{ color: #gdlr#; }"},
...
{name: "related-post-background", selector: ".gdlr-related-post-wrapper{ background-color: #gdlr#; }"},
{name: "related-post-header", selector: ".related-post-header{ color: #gdlr#; }"},
{name: "related-post-title", selector: ".related-post-title a{ color: #gdlr#; }"},
{name: "blog-single-nav-background", selector: ".single-post .gdlr-single-nav{ background-color: #gdlr#; }"},
{name: "blog-single-nav-border", selector: ".single-post .gdlr-single-nav > div.previous-nav{ border-color: #gdlr#; }"},
{name: "blog-single-nav-title", selector: ".single-post .gdlr-single-nav a{ color: #gdlr#; }"},
{name: "blog-single-nav-label", selector: ".single-post .gdlr-single-nav a .single-nav-text { color: #gdlr#; }"},
{name: "blog-author-background", selector: ".gdlr-post-author{ background-color: #gdlr#; }"},
{name: "blog-author-title", selector: ".gdlr-post-author .post-author, .gdlr-post-author .post-author a, .gdlr-post-author .post-author-title{ color: #gdlr#; }"},
{name: "blog-author-content", selector: ".gdlr-post-author .post-author-content{ color: #gdlr#; }"},
...
{name: "blog-tag-background", selector: ".gdlr-single-blog-tag{ background-color: #gdlr#; }"},
{name: "blog-tag-text-color", selector: ".gdlr-single-blog-tag .blog-info, .gdlr-single-blog-tag a, .gdlr-single-blog-tag a:hover, .gdlr-single-blog-tag .blog-info i{ color: #gdlr#; }"},
{name: "portfolio-filter-text", selector: ".portfolio-item-filter, .portfolio-item-filter a{ color: #gdlr#; } "},
{name: "portfolio-filter-text-active", selector: ".portfolio-item-filter a.active, .portfolio-item-filter a:hover{ color: #gdlr#; }"},
...
{name: "portfolio-thumbnail-hover-icon", selector: ".gdlr-image-link-shortcode .gdlr-image-link-icon, .portfolio-thumbnail .portfolio-icon i, .gdlr-modern-portfolio .portfolio-title{ color: #gdlr#; }"},
...
{name: "testimonial-boxed-style-shadow", selector: ".gdlr-testimonial-item.box-style .testimonial-item-inner:after{ border-top-color: #gdlr#; border-left-color: #gdlr#; }.gdlr-testimonial-item.box-style .testimonial-item-inner{ border-color: #gdlr#; }"},
...
{name: "slider-outer-nav-border", selector: ".gdlr-item-title-wrapper .gdlr-flex-prev, .gdlr-item-title-wrapper .gdlr-flex-next{ border-color: #gdlr#; }"},
...
{name: "footer-icon-color", selector: ".footer-wrapper .blog-info i, .footer-wrapper i{ color: #gdlr#; }"},
