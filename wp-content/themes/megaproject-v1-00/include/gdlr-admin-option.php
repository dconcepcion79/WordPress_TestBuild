	...
	if( !function_exists('gdlr_generate_style_custom') ){
		function gdlr_generate_style_custom( $options ){
			...
			foreach($skins as $skin){
				...
				$style .= '#class# a.gdlr-item-title-link i, #class# a.gdlr-item-title-link, #class# a.gdlr-item-title-link:hover{ color: ' . $skin['link'] . '; border-color: ' . $skin['link'] . '; }' . "\n"; 
				$style .= '#class# a:hover, #class# .gdlr-skin-link:hover, #class# .portfolio-item-filter a.active{ color: ' . $skin['link-hover'] . '; }' . "\n"; 
					...
					array(
						...
						'overall-elements' => array(
							...
							'options' => array(
								...
								'top-bar' => array(
									'title' => __('Top Bar / Logo', 'gdlr_translate'),
									'options' => array(
								...
								'header-right' => array(
									'title' => __('Header Right Area', 'gdlr_translate'),
									'options' => array(								
										'header-right-top-margin' => array(
											'title' => __('Header Right Top Margin', 'gdlr_translate'),
											'type' => 'text',
											'default' => '60',
											'selector' => '.logo-right-area{ margin-top: #gdlr#; }',
											'data-type' => 'pixel'
										),
										'header-block-1-icon' => array(
											'title' => __('Header Block 1 Icon', 'gdlr_translate'),
											'type' => 'text',
											'default' => 'fa-location-arrow',
											'description' => __('You can see list of all icon here', 'gdlr_translate') .
												' http://fortawesome.github.io/Font-Awesome/icons/' 
										),
										'header-block-1-title' => array(
											'title' => __('Header Block 1 Title', 'gdlr_translate'),
											'type' => 'text',
										),
										'header-block-1-caption' => array(
											'title' => __('Header Block 1 Caption', 'gdlr_translate'),
											'type' => 'text',									
										),
										'header-block-2-icon' => array(
											'title' => __('Header Block 2 Icon', 'gdlr_translate'),
											'type' => 'text',
											'default' => 'fa-clock-o',											
										),
										'header-block-2-title' => array(
											'title' => __('Header Block 2 Title', 'gdlr_translate'),
											'type' => 'text',									
										),
										'header-block-2-caption' => array(
											'title' => __('Header Block 2 Caption', 'gdlr_translate'),
											'type' => 'text',									
										),
										'header-block-3-icon' => array(
											'title' => __('Header Block 3 Icon', 'gdlr_translate'),
											'type' => 'text',
											'default' => 'fa-phone',								
										),
										'header-block-3-title' => array(
											'title' => __('Header Block 3 Title', 'gdlr_translate'),
											'type' => 'text',									
										),
										'header-block-3-caption' => array(
											'title' => __('Header Block 3 Caption', 'gdlr_translate'),
											'type' => 'text',									
										),
									)
								),		
							...
							'options' => array(
								...
								'top-bar-color' => array(
									...
									'options' => array(						
										...
										'header-background-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-header-wrapper{ background: #gdlr#; }'
										),
										'header-right-text' => array(
											'title' => __('Header Right Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#313131',
											'selector'=> '.logo-right-area{ color: #gdlr#; }'
										),
										'header-right-divider' => array(
											'title' => __('Header Right Divider', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#dcdcdc',
											'selector'=> '.logo-right-area .header-block-area{ border-color: #gdlr#; }'
										),	
										'search-button-divider' => array(
											'title' => __('Search Button Divider', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#506c98',
											'selector'=> '#gdlr-menu-search-button{ border-color: #gdlr#; }'
										),	
										'search-button-icon-color' => array(
											'title' => __('Search Button Icon Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '#gdlr-menu-search-button{ color: #gdlr#; }'
										),	
										'search-box-background' => array(
											'title' => __('Search Box Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#232323',
											'selector'=> '#gdlr-menu-search{ background: #gdlr#; }'
										),	
										'search-box-text' => array(
											'title' => __('Search Box Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
								...
								'main-navigation-color' => array(
									...
									'options' => array(
										'main-navigation-background' => array(
											...
											'type' => 'colorpicker',
											'default' => '#506c98',
											'selector'=> '.gdlr-navigation-wrapper{ background-color: #gdlr#; }'
										),
										'main-navigation-text' => array(
											'title' => __('Main Navigation Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aec0dc',
											'selector'=> '.gdlr-navigation-wrapper .gdlr-main-menu > li > a{ color: #gdlr#; }'
										),	
										...
										'main-navigation-divider' => array(
											'title' => __('Main Navigation Divider', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aec0dc',
											'selector'=> '.gdlr-navigation-wrapper .gdlr-main-menu > li > a{ border-color: #gdlr#; }'
										),
									...
									'options' => array(
										...
										'body-link-color' => array(
											...
											'selector'=> 'a{ color: #gdlr#; }' . 
												'a i.fa-angle-double-right, a i.icon-double-angle-right{ border-color: #gdlr#; }' .
												'a.gdlr-item-title-link, a.gdlr-item-title-link:hover{ color: #gdlr#; border-color: #gdlr#; }'
										),			
										'body-link-hover-color' => array(
											...
											'selector'=> 'a:hover{ color: #gdlr#; }' . 
												'a:hover i.fa-angle-double-right, a:hover i.icon-double-angle-right{ border-color: #gdlr#; }'
										),			
										'border-color' => array(
								...
								'content-item-2' => array(
									...
									'options' => array(		
										...
										'stunning-text-link-color' => array(
											'title' => __('Stunning Text Link Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'data-type' => 'rgba',
											'default' => '#f7c51e',
											'selector'=> '.stunning-text-button, .stunning-text-button:hover{ color: #gdlr#; }' . 
												'.stunning-text-button{ border-color: #gdlr#; border-color: rgba(#gdlra#, 0.5); }'
										),
										'stunning-text-background' => array(
											'title' => __('Stunning Text Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#3d506d',
											'selector'=> '.gdlr-stunning-text-item{ background-color: #gdlr#; }'
										),
										...
										'tab-title-active-background' => array(
											'title' => __('Tab Title Active Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#99a6ba',
											'selector'=> '.tab-title-wrapper .tab-title.active{ background-color: #gdlr#; }' .
												'.gdlr-tab-item > .tab-title-wrapper{ border-color: #gdlr#; }'
										),		
										'tab-title-active-text' => array(
											'title' => __('Tab Title Active Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.tab-title-wrapper .tab-title.active{ color: #gdlr#; }'
										),										
								...
								'blog-color' => array(
									...
									'options' => array(
										...
										'blog-info-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#8b8b8b',
											'selector'=> '.blog-info, .blog-info a{ color: #gdlr#; }'
										),	
										'blog-info-icon' => array(
											'title' => __('Blog Info Icon', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#3c3c3c',
											'selector'=> '.blog-info i{ color: #gdlr#; }'
										),	
										...
										'blog-widget-title' => array(
											'title' => __('Blog Widget Title', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#6f798b',
											'selector'=> '.gdlr-blog-widget .gdlr-blog-title a{ color: #gdlr#; }'
										),	
										'blog-widget-info' => array(
											'title' => __('Blog Widget Info', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#959595',
											'selector'=> '.gdlr-blog-widget .blog-info, .gdlr-blog-widget .blog-info i, .gdlr-blog-widget .blog-info a{ color: #gdlr#; }'
										),
								...
								'blog-2-color' => array(
									'title' => __('Blog Single Color', 'gdlr_translate'),
									'options' => array(
										'related-post-background' => array(
											'title' => __('Related Post Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f5f5f5',
											'selector'=> '.gdlr-related-post-wrapper{ background-color: #gdlr#; }'
										),
										'related-post-header' => array(
											'title' => __('Related Post Header', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#373737',
											'selector'=> '.related-post-header{ color: #gdlr#; }'
										),
										'related-post-title' => array(
											'title' => __('Related Post Title', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#7b7b7b',
											'selector'=> '.related-post-title a{ color: #gdlr#; }'
										),
										'blog-single-nav-background' => array(
											'title' => __('Blog Single Nav Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ebebeb',
											'selector'=> '.single-post .gdlr-single-nav{ background-color: #gdlr#; }'
										),
										'blog-single-nav-border' => array(
											'title' => __('Blog Single Nav Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#cccccc',
											'selector'=> '.single-post .gdlr-single-nav > div.previous-nav{ border-color: #gdlr#; }'
										),
										'blog-single-nav-title' => array(
											'title' => __('Blog Single Nav Title', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#666666',
											'selector'=> '.single-post .gdlr-single-nav a{ color: #gdlr#; }'
										),
										'blog-single-nav-label' => array(
											'title' => __('Blog Single Nav Label', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#8e8e8e',
											'selector'=> '.single-post .gdlr-single-nav a .single-nav-text { color: #gdlr#; }'
										),
										'blog-author-background' => array(
											'title' => __('Blog Author Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ebebeb',
											'selector'=> '.gdlr-post-author{ background-color: #gdlr#; }'
										),
										'blog-author-title' => array(
											'title' => __('Blog Author Title', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#373737',
											'selector'=> '.gdlr-post-author .post-author, .gdlr-post-author .post-author a, ' . 
												'.gdlr-post-author .post-author-title{ color: #gdlr#; }'
										),
										'blog-author-content' => array(
											'title' => __('Blog Author Content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#828282',
											'selector'=> '.gdlr-post-author .post-author-content{ color: #gdlr#; }'
										),
										...
										'blog-tag-background' => array(
											'title' => __('Single Blog Tag Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f5f5f5',
											'selector'=> '.gdlr-single-blog-tag{ background-color: #gdlr#; }'
										),			
										'blog-tag-text-color' => array(
											'title' => __('Single Blog Tag Text Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#353535',
											'selector'=> '.gdlr-single-blog-tag .blog-info, .gdlr-single-blog-tag a, .gdlr-single-blog-tag a:hover, .gdlr-single-blog-tag .blog-info i{ color: #gdlr#; }'
										)								
									)
								),								
								...
								'portfolio-color' => array(
									...
									'options' => array(
										...
										'portfolio-filter-text-active' => array(
											...
											'type' => 'colorpicker',
											'default' => '#282d36',
											'selector'=> '.portfolio-item-filter a.active, .portfolio-item-filter a:hover{ color: #gdlr#; }'
										),	
										...
										'portfolio-thumbnail-hover-icon' => array(
											...
											'selector'=> '.gdlr-image-link-shortcode .gdlr-image-link-icon, ' . 
												'.portfolio-thumbnail .portfolio-icon i, .gdlr-modern-portfolio .portfolio-title{ color: #gdlr#; }'
										),										
										...
										'port-carousel-nav-background' => array(
											'title' => __('Port Carousel Nav Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#171717',
											'selector'=> '.portfolio-item-wrapper .gdlr-item-title-wrapper .gdlr-flex-prev, .portfolio-item-wrapper .gdlr-item-title-wrapper .gdlr-flex-next{ background-color: #gdlr#; }'
										),		
								...
								'personnel-testimonial-color' => array(
									...
									'options' => array(
										...
										'testimonial-boxed-style-shadow' => array(
											...
											'type' => 'colorpicker',
											'default' => '#dddddd',
											'selector'=> '.gdlr-testimonial-item.box-style .testimonial-item-inner:after{ border-top-color: #gdlr#; border-left-color: #gdlr#; }' . 
												'.gdlr-testimonial-item.box-style .testimonial-item-inner{ border-color: #gdlr#; }'
										),										
									)
								),
								...
								'slider-input-color' => array(
									...
									'options' => array(
										...
										'slider-outer-nav-border' => array(
											'title' => __('Slider Outer Navigation Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#e4e4e4',
											'selector'=> '.gdlr-item-title-wrapper .gdlr-flex-prev, .gdlr-item-title-wrapper .gdlr-flex-next{ border-color: #gdlr#; }'
										),			
								...
								'footer-color' => array(
									...
									'options' => array(
										...
										'footer-icon-color' => array(
											'title' => __('Footer Icon Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#b5b5b5',
											'selector'=> '.footer-wrapper .blog-info i, .footer-wrapper i{ color: #gdlr#; }'
										),	
