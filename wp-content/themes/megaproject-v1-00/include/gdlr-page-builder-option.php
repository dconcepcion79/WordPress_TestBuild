			...
			$title = array(
				'title-type'=> array(	
					...
					'options'=> array(
						...
						'left-bold'=> __('Left Bold' ,'gdlr_translate'),
				...
				'title'=> array(	
					...
					'type'=> 'text',
					'wrapper-class'=>'title-type-wrapper left-bold-wrapper left-wrapper center-wrapper left-divider-wrapper center-divider-wrapper'
				),			
				'caption'=> array(	
								...
								'stunning-text' => array(
									...
									'options'=>array(
										...
										'button-text'=> array(
											...
											'type'=> 'text',
											'default'=> __('Get the quote', 'gdlr_translate')
										),		
										'button-link'=> array(
