		...
		function gdlr_register_post_admin_option( $array ){		
			...
			$post_option = array(
				...
				'options' => array(
					...
					'single-post-related' => array(
						'title' => __('Enable Related Post', 'gdlr_translate'),
						'type'=> 'checkbox'
					),
					'related-post-num-fetch' => array(
						'title' => __('Related Post Num Fetch', 'gdlr_translate'),
						'type'=> 'text',
						'default'=> '4'
					),
					'related-post-thumbnail-size' => array(
						'title' => __('Related Post Thumbnail Size', 'gdlr_translate'),
						'type'=> 'combobox',
						'options'=> gdlr_get_thumbnail_list(),
