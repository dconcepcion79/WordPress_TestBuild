		...
		function gdlr_create_portfolio_options(){
			...
			new gdlr_page_options( 
				...
				array(
					...
					'meta_title' => __('Goodlayers Project Option', 'gdlr-portfolio'),
				...
				array(
					'page-layout' => array(
						...
						'options' => array(
								'port-page-style' => array(
									'title' => __('Project Page Style', 'gdlr-portfolio'),
									'type' => 'combobox',
									'options' => array(
										'default'=>__('Default', 'gdlr-portfolio'),
										'style1'=>__('Style 1', 'gdlr-portfolio'),
										'style2'=>__('Style 2', 'gdlr-portfolio'),
									),
									'default' => 'no-sidebar'
								),	
								'sidebar' => array(
									'title' => __('Sidebar Layout', 'gdlr-portfolio'),
									'type' => 'radioimage',
									'options' => array(
					...
					'page-option' => array(
						...
						'options' => array(
							...
							'location' => array(
								'title' => __('Location' , 'gdlr-portfolio'),
								'type' => 'text',
							),
							'scope-of-work' => array(
								'title' => __('Scope Of Work' , 'gdlr-portfolio'),
								'type' => 'text',
							),
							'schedule' => array(
								'title' => __('Schedule' , 'gdlr-portfolio'),
								'type' => 'text',
							),
							'architect' => array(
								'title' => __('Architect' , 'gdlr-portfolio'),
								'type' => 'text',
							),							
	...
	if( !function_exists('gdlr_register_portfolio_item') ){
		function gdlr_register_portfolio_item( $page_builder = array() ){
			...
			$page_builder['content-item']['options']['portfolio'] = array(
				'title'=> __('Project', 'gdlr-portfolio'), 
				'type'=>'item',
				'options'=>array_merge(gdlr_page_builder_title_option(true), array(					
					...
					'portfolio-style'=> array(
						'title'=> __('Project Style' ,'gdlr-portfolio'),
						'type'=> 'combobox',
						'options'=> array(
					...
					'portfolio-size'=> array(
						'title'=> __('Project Size' ,'gdlr-portfolio'),
						'type'=> 'combobox',
						'options'=> array(
							'1/4'=>'1/4',
							'1/3'=>'1/3',
						...
						'default'=>'1/3',
						'wrapper-class'=>'portfolio-style-wrapper modern-portfolio-wrapper modern-portfolio-no-space-wrapper classic-portfolio-wrapper classic-portfolio-no-space-wrapper'
					),					
					'portfolio-layout'=> array(
						'title'=> __('Project Layout Order' ,'gdlr-portfolio'),
						'type'=> 'combobox',
						'options'=> array(
					...
					'portfolio-filter'=> array(
						'title'=> __('Enable Project filter' ,'gdlr-portfolio'),
						'type'=> 'checkbox',
						'default'=> 'disable',
