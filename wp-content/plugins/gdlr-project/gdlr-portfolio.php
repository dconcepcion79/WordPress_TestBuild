<?php
/*
Plugin Name: Goodlayers Project Post Type
Plugin URI: 
...
if( !function_exists('gdlr_create_portfolio') ){
	function gdlr_create_portfolio() {
		...
		register_post_type( 'portfolio',
			array(
				'labels' => array(
					'name'               => __('Projects', 'gdlr-portfolio'),
					'singular_name'      => __('Project', 'gdlr-portfolio'),
					'add_new'            => __('Add New', 'gdlr-portfolio'),
					'add_new_item'       => __('Add New Project', 'gdlr-portfolio'),
					'edit_item'          => __('Edit Project', 'gdlr-portfolio'),
					'new_item'           => __('New Project', 'gdlr-portfolio'),
					'all_items'          => __('All Projects', 'gdlr-portfolio'),
					'view_item'          => __('View Project', 'gdlr-portfolio'),
					'search_items'       => __('Search Project', 'gdlr-portfolio'),
					'not_found'          => __('No projects found', 'gdlr-portfolio'),
					'not_found_in_trash' => __('No projects found in Trash', 'gdlr-portfolio'),
					'parent_item_colon'  => '',
					'menu_name'          => __('Projects', 'gdlr-portfolio')
				),
				'public'             => true,
		...
		register_taxonomy(
			'portfolio_category', array("portfolio"), array(
				...
				'label' => __('Project Categories', 'gdlr-portfolio'), 
				'singular_label' => __('Project Category', 'gdlr-portfolio'), 
		...
		register_taxonomy(
			'portfolio_tag', array('portfolio'), array(
				'hierarchical' => false, 
				'show_admin_column' => true,
				'label' => __('Project Tags', 'gdlr-portfolio'), 
				'singular_label' => __('Project Tag', 'gdlr-portfolio'),  
